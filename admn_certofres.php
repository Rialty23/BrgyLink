...
$view = $bmis->view_certofres($showArchived);
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col text-center">
            <h1><?= $showArchived ? 'Archived Certificate of Residency Requests' : 'Certificate of Residency Requests'; ?></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <form method="POST">
                ...
                <a href="admn_certofres.php<?= $showArchived ? '?archived=1' : ''; ?>" class="btn btn-info" style="width: 70px; font-size: 15px; border-radius:5px;">Reload</a>
            </form>
        </div>
    </div>
    ...
    <?php if ($showArchived): ?>
        <a href="admn_certofres.php" class="btn btn-info" style="color: white; width: 120px; height: 40px; font-size: 14px; border-radius:5px; margin-bottom: 5px; margin-left: auto; margin-right: auto;">Active Files</a>
    <?php else: ?>
        <a href="admn_certofres.php?archived=1" class="btn btn-warning" style="color: white; width: 120px; height: 40px; font-size: 14px; border-radius:5px; margin-bottom: 5px; margin-left: auto; margin-right: auto;">Archived Files</a>
    <?php endif; ?>
...
<script>
    document.getElementById('exportExcelBtn').addEventListener('click', function() {
        ...
        downloadLink.download = 'resident_certificate_records.csv';
