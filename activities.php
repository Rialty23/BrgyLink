...
<div class="container-fluid">
    ...
    <button class="btn btn-info" style="width: 100px; height: 40px; font-size: 14px; border-radius:5px; margin-bottom: 5px;" data-toggle="modal" data-target="#modalServices">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="paa">
                        ...
                        <button id="styled_button_approve"  name="add_activity" type="submit" class="btn btn">Add Activity</button>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="post">
                                    <a href="update_activity_form.php?id_activity=<?= $view['id_activity']; ?>" class="btn btn-info" style="width: 100px; font-size: 15px; border-radius:5px; margin-bottom: 2px;">Update</a>
                                    <input type="hidden" name="id_activity" value="<?= $view['id_activity']; ?>">
                                    <button class="btn btn-danger" type="submit" name="delete_activity" style="width: 100px; font-size: 15px; border-radius:5px;" onclick="return confirm('Delete this activity?');">Delete</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
