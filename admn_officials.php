...
<body>
    ...
    <div class="container-fluid">
        ...
        <button class="btn btn-info" style="width: 95px; height: 40px; font-size: 14px; border-radius:5px; margin-bottom: 5px;" data-toggle="modal" data-target="#modalOfficial"><i class="fas fa-plus icon" style="padding-left: 0; padding-top: 0; padding-bottom: 0;"></i>Add</button>
        <br>
                ...
                <div class="modal-content">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select name="position" class="form-control" required>
                                            ...
                                            <option value="Sangguniang Kabataan Chairman">Sangguniang Kabataan Chairman</option>

                                            <option value="Barangay Secretary">Barangay Secretary</option>

                                            <option value="Barangay Treasurer">Barangay Treasurer</option>

                                            <option value="Chairperson, Committee on Health & Sanitation">
                                                Chairperson, Committee on Health & Sanitation
                                            </option>

                                            <option value="Chairman, Committee on Environment (Clean & Green)">
                                                Chairman, Committee on Environment (Clean & Green)
                                            </option>

                                            <option value="Chairman, Committee on Budget & Appropriation">
                                                Chairman, Committee on Budget & Appropriation
                                            </option>

                                            <option value="Chairman, Committee on Peace & Order">
                                                Chairman, Committee on Peace & Order
                                            </option>

                                            <option value="Chairman, Committee on Social Culture & Special Affairs">
                                                Chairman, Committee on Social Culture & Special Affairs
                                            </option>

                                            <option value="Chairman, Committee on Infrastructure">
                                                Chairman, Committee on Infrastructure
                                            </option>

                                            <option value="Chairman, Committee on Ways & Means">
                                            ...
                                            <option value="Utility Workers">Utility Workers</option>
                    ...
                    <div class="modal-footer">
                        <div class="paa">
                            ...
                            <button  id="styled_button_approve" name="add_official" type="submit" class="btn btn-success">Add Official</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <?php if (is_array($view)) { ?>
                            <?php foreach ($view as $view) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="" method="post">
                                            <a href="update_official_form.php?id_official=<?= $view['id_official']; ?>" class="btn btn-info"> Update </a>
                                            <input type="hidden" name="id_user" value="<?= $view['id_user']; ?>">
