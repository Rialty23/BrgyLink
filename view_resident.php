...
?>
        <div class="section">
            <div class="section-title">Uploaded Valid IDs</div>
            
            <div class="info-grid">
                <div class="info-box">
                    <div class="info-label">ID 1</div>
                    <div class="info-value"><?= $resident['id1']; ?></div>
                    <img src="uploads/validID/<?= $resident['id1']; ?>"
                        class="img-fluid img-thumbnail preview-img"
                        style="max-height: 250px; cursor: pointer;"
                        data-toggle="modal"
                        data-target="#imagePreviewModal"
                        data-img="<?= $base_url ?>/uploads/validID/<?= $resident['id1']; ?>">
                </div>

                <div class="info-box">
                    <div class="info-label">ID 2</div>
                    <div class="info-value"><?= $resident['id2']; ?></div>
                    <img src="uploads/validID/<?= $resident['id2']; ?>"
                        class="img-fluid img-thumbnail preview-img"
                        style="max-height: 250px; cursor: pointer;"
                        data-toggle="modal"
                        data-target="#imagePreviewModal"
                        data-img="<?= $base_url ?>/uploads/validID/<?= $resident['id2']; ?>">
                </div>
