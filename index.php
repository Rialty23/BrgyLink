...
<body class="bg-gray-50">
  ...
  <header class="bg-white shadow-md fixed w-full z-50">
    <div class="max-w-7xl mx-auto px-4 flex items-center justify-between h-20 sm:h-24">
      ...
      <ul class="hidden md:flex gap-6 font-semibold text-blue-900">
        ...
        <li><a href="#activity" class="hover:text-blue-700 transition">ACTIVITIES</a></li>
  ...
  <main class="pt-24 sm:pt-28 md:pt-32">
    ...
    <section id="home" class="bg-cover bg-center relative" style="background-image: linear-gradient(rgba(17,43,90,0.5), rgba(17,43,90,0.5)), url('assets/s4.jpg'); height: 75vh; margin-top: -1px;">
    ...
    <section id="about" class="py-12 sm:py-16 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div class="flex justify-center opacity-0 translate-y-10 transition-all duration-700 ease-out" data-animate>
          <img src="assets/logos.png" class="w-65 h-65 rounded-full transform hover:scale-105 transition duration-500" alt="about">
        </div>
      </div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8">
        <div>
          ...
          <div class="flex gap-3 mt-2">
            <a href="https://www.facebook.com/eastmodernsite.barangay" class="hover:text-gray-300"><i class="ri-facebook-fill"></i></a>
          </div>
        </div>
        <div>
