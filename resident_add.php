                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!-- Re-enter Email (BELOW EMAIL FIELD) -->
                                     <label class="form-label">Re-Enter Email:</label><span style="color:red;">*</span>
                                    <input type="email" class="form-control" id="confirm_email" name="confirm_email" placeholder="RE-ENTER EMAIL" required>
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                ?>
                                <div class="col-md-3">
                                    <h6>PSA Birth Certificate?<span style="color:red;">*</span></h6>
                                        <?php renderRadio('psa', $radioOptions); ?>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Correction in PSA?<span style="color:red;">*</span></h6>
                                    ...
                                    <div class="col-md-3">
                                        <h6>National ID?<span style="color:red;">*</span></h6>
                                    ...
                                    <div class="col-md-3">
                                        <h6>Head of Family?<span style="color:red;">*</span></h6>
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col-md-3">
                                        <h6>Domesticated Animals?<span style="color:red;">*</span></h6>
                                        <?php renderRadio('d_a', $radioOptions); ?>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Trees in Yard?<span style="color:red;">*</span></h6>
                                        <?php renderRadio('trees', $radioOptions); ?>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Farmer?<span style="color:red;">*</span></h6>
                                        <?php renderRadio('farmer', $radioOptions); ?>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Grow Vegetables?<span style="color:red;">*</span></h6>
                                        <?php renderRadio('veges', $radioOptions); ?>
                                    </div>
                                </div>
