                ...
                <form method="post" onsubmit="return handleUpdateFormSubmit()">
                        ...
                        <div class="row" style="margin-top: 1.1em;">
                            <div class="col">
                                ...
                                <input type="tel" class="form-control" name="contact" pattern="[0-9]{3}-[0-9]{4}" placeholder="Enter Contact Number" value="<?= $info['contact'];?>">
                            </div>
                            <div class="col">
                        ...
                        <center><button id="styled_button_approve" class="btn btn-success" type="submit" name="update_brgy_info" style="width: 120px; font-size: 18px; border-radius:30px;"> 
                            Update 
                        </button></center>
                        <br><br>
                    </form>         
