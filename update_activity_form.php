            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" onsubmit="return handleFormSubmit()">
                        ...
                        <center> <?php include('styled_button.php'); ?>
                            <button id="styled_button_approve" class="btn btn-success" type="submit" name="update_activity" style="width: 120px; font-size: 18px; border-radius:5px;">
                                Update
                            </button>
